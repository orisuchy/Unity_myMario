...
public class EnemyAi : MonoBehaviour
{
    ...
    void CheckWalls(Vector3 pos, float direction){
        ...
        RaycastHit2D wallBottom = Physics2D.Raycast(originBottom, Vector2.down, velocity.x * Time.deltaTime, wallMask);
        if(wallTop.collider != null || wallBottom.collider != null || wallBottom.collider != null){
